...
\resumeItem{Full-stack engineer with experience in Python, Next.js, and Postgres, seeking to leverage AI/LLM expertise in a fast-paced healthcare setting.}
...
\resumeItemListStart
\resumeItem{Developed and deployed full-stack Java applications, delivering features under tight deadlines.}
\resumeItem{Collaborated with cross-functional teams to design, implement, and maintain scalable software solutions.}
...
\resumeItemListStart
\resumeItem{Contributed to the development of a key feature resulting in a 10\% increase in user engagement.}
\resumeItem{Successfully debugged and resolved critical production issues, minimizing downtime.}
\resumeItem{Gained valuable experience in Agile software development methodologies.}
\resumeItemListEnd
\resumeSubHeadingListEnd\vspace{-17pt}
\section{{\fontsize{9pt}{20pt}\selectfont \textbf{PROJECTS}}}\resumeSubHeadingListStart
\resumeProjectHeading{\textbf{AI-Powered Healthcare Chatbot}}{\textit{March 2023 - August 2023}}
\resumeItemListStart
\resumeItem{Developed a Next.js frontend for an AI-powered chatbot using a Python backend and Postgres database.}
\resumeItem{Integrated a Chrome extension for seamless user access, improving user experience by 20\%.}
\resumeItem{Deployed the application to production, resulting in a 15\% increase in user engagement.}
\resumeItemListEnd\vspace{-6pt}
\resumeProjectHeading{\textbf{Automated Medical Report Generation System}}{\textit{October 2022 - February 2023}}
\resumeItemListStart
\resumeItem{Designed and implemented a system for automated generation of medical reports using LLMs, improving efficiency by 30\%.}
\resumeItem{Utilized Python for backend processing and integrated with a secure database for data storage.}
\resumeItem{Successfully met aggressive deadlines, delivering a functional and scalable system.}
\resumeItemListEnd\vspace{-6pt}
\resumeProjectHeading{\textbf{Patient Data Management System}}{\textit{June 2022 - September 2022}}
\resumeItemListStart
\resumeItem{Built a secure and scalable system for managing patient data using Python and a Postgres database.}
\resumeItem{Implemented robust security measures to protect sensitive patient information, exceeding HIPAA compliance standards.}
\resumeItem{Achieved a 99.9\% uptime, ensuring reliable access to critical patient data.}
\resumeItemListEnd
\resumeSubHeadingListEnd\vspace{-17pt}
