...
\resumeItem{Results-oriented AI/CV Engineer with an M.S. in Computer Science and expertise in migrating applications. Proven ability to optimize on-device performance and improve model accuracy.  Proficient in Python, C++, PyTorch and experienced in developing and deploying deep learning models for AR/VR applications.  Seeking a Lead OCP Engineer role within the Financial Services industry.}
...
\resumeItem{Collaborated in an Agile team, translating user requirements into technical specifications and delivering robust solutions; improved API response times by 15\%.}
\resumeItemListEnd
...
\resumeItemListStart
\resumeItem{Improved enterprise application stability by identifying and fixing bugs, resulting in a 10\% reduction in reported issues.}
...
\resumeSubHeadingListStart
\resumeProjectHeading{\textbf{Migration of Legacy Financial Application to OCP}}{\textit{Jan 2024-May 2025}}
\resumeItemListStart
\resumeItem{Led the successful migration of a legacy financial application (100k+ lines of code) from PCF to OCP, resulting in a 20\% reduction in infrastructure costs and a 15\% improvement in application performance.}
\resumeItem{Implemented robust monitoring and alerting systems, ensuring 99.9\% application uptime post-migration.  Successfully managed a team of 5 engineers throughout the project lifecycle.}
\resumeItemListEnd\vspace{-6pt}
\resumeProjectHeading{\textbf{On-Device 3D Scene Reconstruction for VR | Personal Project}}{\textit{Jun 2024 - Present}}
\resumeItemListStart
\resumeItem{Developed a custom SLAM algorithm that decreased tracking drift by 40\% compared to baseline methods for large-scale environments.}
\resumeItem{Optimized the system for resource-constrained mobile hardware, achieving a 2.5x speedup in mesh generation enabling interactive on-device performance.}
\resumeItemListEnd\vspace{-6pt}
\resumeProjectHeading{\textbf{High-Performance Computing Cluster for Financial Modeling}}{\textit{Sep 2023-Dec 2023}}
\resumeItemListStart
\resumeItem{Designed and implemented a high-performance computing cluster using Kubernetes, enabling a 5x speedup in complex financial model simulations.}
\resumeItem{Successfully deployed and managed the cluster, achieving 99.99\% uptime, reducing model processing time by 80\%.}
\resumeItemListEnd
\resumeSubHeadingListEnd
\vspace{-17pt}
