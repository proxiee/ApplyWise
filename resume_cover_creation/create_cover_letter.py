...
def generate_cover_letter_body(model, full_resume_data, job_desc):
    ...
    **Instructions:**
    ...
    5.  **Mirror Language and Specify Impact:** Reflect the tone, keywords, and priorities found in the job description. Align your phrasing with the company’s voice and highlight achievements that relate directly to their stated needs.
